...
cloudflared access tcp --hostname mariadb.davidson.dev.br --url 127.0.0.1:3306 --service-token-id "$CF_ACCESS_CLIENT_ID" --service-token-secret "$CF_ACCESS_CLIENT_SECRET" &
